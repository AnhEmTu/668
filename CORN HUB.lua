...
local Window = Fluent:CreateWindow({
    Title = "CORN HUB ",
    SubTitle = "Version2.0 by nghiabaptuoi",
    TabWidth = 160,
...
local Tabs = {
    ...
    Hop = Window:AddTab({ Title = "đổi sv", Icoyn = "user" }),
...
ImageButton.Image = "rbxassetid://16486409560"
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    spawn(function()
        ...
        local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( Chỉ Cấp Max thôi nè )",Description = "", Default = false })
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {
        Title = "Đánh Hải Tặc ở Pháo Đài nè",
        Description = "", 
        Default = false })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {
        Title = "Cày Mastery Trái ác quỷ nè",
        Description = "", 
        Default = false })
...
local boss = Tabs.Main:AddSection("Farm Boss")
    ...
    local Material = Tabs.Main:AddSection("Farm Nguyên Liệu nè")
    ...
    spawn(function()
      ...
      local ToggleEspKitsune = Tabs.Main:AddToggle("ToggleEspKitsune", {Title = "Định vị Đảo kisune nè",Description = "", Default = false })
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Di Chuyển Đến Đảo Kisune nè",Description = "", Default = false })
...
spawn(function()
    ...
    local AutoElite = Tabs.Main:AddSection("Farm Boss Bí Ẩn nè")

    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Đánh Boss Bí Ẩn nè",Description = "", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Treo + Đánh Thủy Quái nè",Description = "", Default = false })
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Nhặt Bánh Răng nè",Description = "", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Treo Đảo Bí Ẩn nè",Description = "", Default = false })
...
if Third_Sea then
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Cày Lưỡi Hái Bóng Tối nè ( Từ A - Z )",Description = "", Default = false })
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title = "Auto Mua Chip nè", Description = "",Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Auto Vào Raid nè",Description = "", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Auto Qua Đảo nè",Description = "", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Thức tỉnh V2 nè",Description = "", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Tự mua chip nè và đập boss law",Description = "", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Cày + Bật Tộc nè",Description = "", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Đổi Xương nè",Description = "(chúc bạn may mắn)", Default = false })
...
Tabs.Misc:AddButton({
	Title = "Mở bảng thức tỉnh chiêu nè",
	Description = "",
	Callback = function()
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "Tự động vào lại khi bị văng nè", Description = "",Default = true })
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Tìm đảo bí ẩn nè",Description = "", Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Di Chuyển Dạng Reset nè",Description = "", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Ẩn Dame Đánh Quái nè",Description = "", Default = true })
...
local ToggleRemoveNotify = Tabs.Setting:AddToggle("ToggleRemoveNotify", {Title = "Xoá Hết Thông báo nè",Description = "", Default = false })
